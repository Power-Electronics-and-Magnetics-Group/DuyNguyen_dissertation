...
format long
Tsw=1e-6; % This frequency is 150kHz
fsw=1/Tsw;
cycle = 200;
%Tsw = 1e-6; % 1MHz
sample = 1000;
...
Ro_i = [0.001 0.5 1 1.5 2]; % Parasitic resistor of boost circuit
Cf_i = 0.1e-6:0.05e-6:3e-6;   % Capacitor of AEF
...
legend('\it{R} = 0 \Omega','\it{R} = 0.5 \Omega','\it{R} = 1 \Omega','\it{R} = 1.5 \Omega','\it{R} = 2 \Omega','Location','southeast','FontSize',18);
legend('boxoff')
h=gcf;
